    ...
    players_points_count.each do |player|
      ...
      if (games_city_victories - games_mafia_victories == 0) || games_city_victories == 0 || games_mafia_victories == 0
        ...
        if games_city_victories > games_mafia_victories
          ...
          if @tour.id >= 9
            object[:rating] += ((@additional_coefficient + 1) * 2 - 2) * player_win_mafia + (object[:penalty_amount] * (-0.5))
          else
          ...
          if @tour.id >= 9
            object[:rating] += ((@additional_coefficient +1) * 2 - 2) * player_win_citizen + (object[:penalty_amount] * (-0.5))
          else
