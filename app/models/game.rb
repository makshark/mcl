class Game < ActiveRecord::Base
  ...
  def self.main_excel_parser
    ...
    # while list_number < 102 do
      ...
      # nick_for_player        = player_nick_by_field(game_page.row(18)[11], players)
      ...
      #Присваивание очков первоубиенному
       pl = GamePlayer.where(player_id: killed_first_id, game_id: game.id).first
       best_player_move_count = pl.best_move
       pl.update_attributes(points: pl.points + best_player_move_count) unless best_player_move_count == 0
      #---------------------------------
    #   list_number +=1
    # end
    3/0
